(function () {
    ...
    const USER_STEPS = [
        ...
        },
        {
            ...
            title: "領収書発行月を選びます",
            body: "何月に発行された領収書を提出するか選びます。例えば6月分の領収書を出す場合は「2026年06月」を選びます。月を選ぶと、その月の画面へ自動的に切り替わります。",
            placement: "left",
        },
        {
            pageName: "dashboard",
    ...
    const STAFF_STEPS = [
        ...
        },
        {
            ...
            title: "ステータス別に領収書を確認します",
            body: "AI未確認、確認が必要、再提出判断待ち、AI確認済み、管理者確認済みを切り替え、対応が必要な領収書だけを確認できます。確認内容は行内で展開し、問題候補は領収書本体を開いて最終判断します。",
            placement: "above",
        },
        {
            ...
            title: "ご利用代金明細ページです",
            body: "会社全体のカード明細をアップロードし、明細月と同じ領収書発行月として登録された全ユーザー領収書を一括照合します。例えば7月分明細は、領収書発行月7月の領収書と照合します。",
            placement: "below",
        },
        {
            pageName: "staff_card_statements",
            ...
            body: "明細月を選び、ユーザーを指定せずに会社共通のご利用代金明細書をアップロードします。AIが明細表の全行を抽出し、同じ領収書発行月として登録された領収書と照合します。",
            placement: "above",
        },
        {
            pageName: "staff_card_statements",
