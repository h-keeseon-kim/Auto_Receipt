...
urlpatterns = [
    ...
    path("staff/users/<int:user_id>/month/card-statement/upload/", views.staff_upload_card_statement, name="staff_upload_card_statement"),
    path("staff/users/<int:user_id>/month/card-statement/status/", views.staff_card_statement_status, name="staff_card_statement_status"),
